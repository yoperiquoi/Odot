...
<main role='main' class='container bg-white py-2 px-5 border my-5  p-5 text-center'>
    <form class="form-signin" method="POST" action="../../Modele/GestionUtilisateur/TrouverUtilisateur.php">
        ...
        <div class="mt-3">
            <a href="../../Vue/PageInscription/PageIncription.php">Pas de compte ? Inscrivez-vous !</a>
        </div>
    </form>
</main>
</body>
